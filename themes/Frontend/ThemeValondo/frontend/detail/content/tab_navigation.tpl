    ...
    <div class="tab--navigation">
        {block name="frontend_detail_index_tabs_navigation_inner"}
            ...
            {block name="frontend_detail_index_tabs_entry_also_bought"}
                {if $showAlsoBought}
                    <a href="#content--also-bought" title="{s name="DetailRecommendationAlsoBoughtLabel" namespace="frontend/detail/index"}{/s}" class="tab--link also-bought-target">{s name="DetailRecommendationAlsoBoughtLabel" namespace="frontend/detail/index"}{/s}</a>
                {/if}
            {/block}
