...
{block name='frontend_detail_actions_review'}
    <a href="#content--reviews" class="action--link pr-details-btn" rel="nofollow">
        <i class="icon--info2"></i> Produktdetails
    </a>

    <a href="#content--also-bought" class="action--link also-bought-btn" rel="nofollow">
        <i class="icon--basket"></i> Kunden kauften auch
    </a>
